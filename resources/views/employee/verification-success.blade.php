    ...
    <div class="max-w-md w-full mx-4">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 px-8 py-6 text-center">
                ...
                <h1 class="text-2xl font-bold text-white">¡Verificación Exitosa!</h1>
            </div>
                ...
                <div class="text-center mb-6">
                    ...
                    @if(!$alreadyVerified)
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                            <p class="text-green-700 text-sm">
                                ...
                                Tu cuenta está ahora activa y puedes acceder al sistema.
                            </p>
                        </div>
                    @endif
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-6">
                        ...
                        <div class="text-left space-y-2 text-sm text-gray-600">
                            ...
                            <p><strong>Rol:</strong> {{ ucfirst($employee->role) }}</p>
