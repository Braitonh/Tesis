        ...
        <main class="py-8 px-4 sm:px-6 lg:px-8 max-full mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-red-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-semibold uppercase mb-1">Bloqueados</p>
                            <p class="text-3xl font-bold text-gray-800">{{ $stats['bloqueados'] }}</p>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-purple-500">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-sm font-semibold uppercase mb-1">Verificados</p>
                            <p class="text-3xl font-bold text-gray-800">{{ $stats['verificados'] }}</p>
                        </div>
