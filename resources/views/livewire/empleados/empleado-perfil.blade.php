                ...
                <form wire:submit="actualizarPerfil">
                    ...
                    <div class="mb-6">
                        ...
                        <input 
                            ...
                            id="dni"
                            wire:model="dni"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-300 @error('dni') border-red-500 @enderror"
